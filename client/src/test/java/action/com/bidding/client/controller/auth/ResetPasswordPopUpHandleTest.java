...
import action.controller.auth.ResetPasswordPopUpHandle;
...
public class ResetPasswordPopUpHandleTest {
    ...
    public void testReturnToLogin_ClosesStage() throws InterruptedException {
        ResetPasswordPopUpHandle controller = new ResetPasswordPopUpHandle();
