...
class SocketClientTest {
    ...
    void setUp() throws IOException {
        // Tạo một server ảo mở ở 1 port ngẫu nhiên đang trống
    ...
    void testConnectAndReceiveData() throws InterruptedException {
        ...
        // Luồng server ảo lắng nghe kết nối từ SocketClient
        serverThread = new Thread(() -> {
            try {
                ...
                out.println(testMessage); // Gửi tin nhắn đến SocketClient
            } catch (IOException e) {
                // Ignore khi bị ngắt
            }
        });
        ...
        // Đợi tối đa 2 giây để nhận dữ liệu từ luồng Server
    ...
    void testRequestData() throws InterruptedException {
        ...
        // Luồng server ảo để đón kết nối và đọc thông điệp Client gửi lên
        serverThread = new Thread(() -> {
            try {
                clientSocketOnServerSide = dummyServer.accept();
        ...
        // Cần đợi 1 chút để luồng kết nối thiết lập xong các Stream
        Thread.sleep(200);
